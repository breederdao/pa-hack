...
// Hex below is the result of `WorldResourceIdLib.encode({ namespace: "action", name: "KingOfTheHillCon", typeId: RESOURCE_TABLE });`
ResourceId constant _tableId = ResourceId.wrap(0x7462616374696f6e00000000000000004b696e674f6654686548696c6c436f6e);
